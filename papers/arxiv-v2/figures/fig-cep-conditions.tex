...
\begin{tikzpicture}[
  ...
  gate/.style={draw=figaccent, line width=0.7pt, circle, text=figaccent,
               font=\Large, minimum size=14mm, fill=figaccentfill},
  obox/.style={draw=figline, line width=0.5pt, rounded corners=2pt, align=center,
               text=figline, font=\small\sffamily, fill=figfill,
               text width=28mm, minimum height=14mm, inner sep=4pt},
...
\node[gate, right=30mm of c3] (and) {$\bigwedge$};
\node[obox, right=16mm of and] (sig) {recomputable evidence};
